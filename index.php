      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/img/slide/kopiii.webp" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">
                  ...
                  Savor the flavor journey at The Cozy Caffine!
                  </span>
                </h2>
                <p class="animate__animated animate__fadeInDown"><span id="txt-slide-desc">where every bite tells a tale of culinary delight, turning moments into memories with a taste that lingers on the palate</span></p>
